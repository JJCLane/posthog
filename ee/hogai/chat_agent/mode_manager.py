...
# Execution mode definition - a fictitious mode used to trigger transition out of plan mode
execution_agent = AgentModeDefinition(
    ...
    toolkit_class=SwitchToExecutionAgentToolkit,
    ...
    def __init__(
        ...
        *,
        ...
        if state.agent_mode == AgentMode.PLAN:
            ...
            self._supermode = state.supermode  # None (normal) or PLAN
